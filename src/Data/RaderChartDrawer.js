...
function RaiderChart() 
{
    ...
    return (
        <RadarChart 
            ...
            <Radar
                dataKey="YOU" stroke="#2F4FFD" fill="#2F4FFD" fillOpacity={1}
            />
...
function SetData(userSelect)
{
    ...
    switch (userSelect[1]) { // 성별
        case 1: // 여성
            data[dicType["본질"]].YOU += -1;
            data[dicType["직장"]].YOU += -1;
            data[dicType["재력"]].YOU += -1;
            data[dicType["교육"]].YOU += 0;
            data[dicType["건강"]].YOU += 1;
            break;
        case 2: // 남성
            data[dicType["본질"]].YOU += 2;
            data[dicType["직장"]].YOU += 2;
            data[dicType["재력"]].YOU += 2;
            data[dicType["교육"]].YOU += 2;
            data[dicType["건강"]].YOU += 2;
            break;
    }
    ...
    switch (userSelect[2]) { // 나이
        ...
        case 3: // 30 ~ 39
            ...
            data[dicType["직장"]].YOU += 2;
            data[dicType["재력"]].YOU += 2;
            data[dicType["교육"]].YOU += 1;
            data[dicType["건강"]].YOU += 1;
            break;
        case 4: // 40 ~ 49
            data[dicType["본질"]].YOU += 0;
            data[dicType["직장"]].YOU += 1;
            data[dicType["재력"]].YOU += 1;
            data[dicType["교육"]].YOU += 0;
            data[dicType["건강"]].YOU += 0;
            break;
        case 5: // 50 ~ 59
            data[dicType["본질"]].YOU += -1;
            data[dicType["직장"]].YOU += -1;
            data[dicType["재력"]].YOU += 0;
            data[dicType["교육"]].YOU += -1;
            data[dicType["건강"]].YOU += -1;
            break;
        case 6: // 60 ~
    ...
    switch (userSelect[7]) { // 결혼
        case 1: // 결혼
            //data[dicType["본질"]].YOU += +1;
            if(userSelect[0] === 0)
                data[dicType["직장"]].YOU += -1; //남성은 +1, 여성은 -1
            else
                data(dicType["직장"]).YOU += 1;
            data[dicType["재력"]].YOU += +1;
            //data[dicType["교육"]].YOU += 0;
