...
function SetData(userSelect)
{
    ...
    data[indexData[1]].A += addictiveData[0][userSelect[1]] // 나이 - 건강
    data[indexData[2]].A += addictiveData[0][userSelect[2]] // 국적 - 본질
    data[indexData[3]].A += addictiveData[0][userSelect[3]] // 퀴어 - 본질
    data[indexData[4]].A += addictiveData[0][userSelect[4]] // 장애 - 건강
    data[indexData[5]].A += addictiveData[0][userSelect[5]] // 수도권 - 본질
    data[indexData[6]].A += addictiveData[0][userSelect[6]] // 결혼 - 본질
    data[indexData[7]].A += addictiveData[0][userSelect[7]] // 불로소득 - 재력
    data[indexData[8]].A += addictiveData[0][userSelect[8]] // 고정지출 - 재력
    data[indexData[9]].A += addictiveData[0][userSelect[9]] // 근로방식 - 직장
    data[indexData[10]].A += addictiveData[0][userSelect[10]] // 근로 규모 - 직장
    data[indexData[11]].A += addictiveData[0][userSelect[11]] // 최종학력 - 교육
    data[indexData[12]].A += addictiveData[0][userSelect[12]] // 교육 장소 - 교육
